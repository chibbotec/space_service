...
class ServiceManager:
    ...
    def _run_container(self, name: str, port: int) -> None:
        os.system(
            f"docker run -d --name={name} --restart unless-stopped -p {port}:9030 -e TZ=Asia/Seoul -v /dockerProjects/chibbotec/space_service/volumes/gen:/gen --pull always ghcr.io/chibbotec/space_service")
    ##
